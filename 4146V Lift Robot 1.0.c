...
#pragma config(Motor,  port9,           sideDriveA,    tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port10,          sideDriveB,    tmotorVex393TurboSpeed_HBridge, openLoop, reversed)
...
task driveTrain ()
{
	while(true) {
		...
		motor[sideDriveA] = vexRT[Ch1];
		motor[sideDriveB] = vexRT[Ch1];
		wait1Msec(25);
	}
}
